...
class ElliaUpdatesTests(unittest.TestCase):
    def test_curated_updates_fill_expected_rows(self) -> None:
        ...
        self.assertEqual(by_id["2725"][SKU_COLUMN], "5292586000603")
        self.assertEqual(by_id["3031"][GTIN_COLUMN], "5292586000337")
        self.assertEqual(by_id["3034"][GTIN_COLUMN], "5292586000313")
        self.assertEqual(by_id["3638"][SKU_COLUMN], "5292586000023")
        self.assertEqual(by_id["3049"][SKU_COLUMN], "5292586000344-CM")
        self.assertEqual(by_id["3053"][SKU_COLUMN], "5292586000344-SN")
        self.assertEqual(by_id["3055"][SKU_COLUMN], "5292586000344-TD")
